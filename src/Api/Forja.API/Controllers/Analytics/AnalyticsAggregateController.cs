...
{
    private readonly IAnalyticsAggregaseService _analyticsAggregaseService;
    private readonly IAuditLogService _auditLogService;

    public AnalyticsAggregateController(IAnalyticsAggregaseService analyticsAggregaseService,
        IAuditLogService auditLogService)
    {
        _analyticsAggregaseService = analyticsAggregaseService;
        ...
        [FromQuery] DateTime? endDate = null)
    {
        try
        {
            var result = await _analyticsAggregaseService
